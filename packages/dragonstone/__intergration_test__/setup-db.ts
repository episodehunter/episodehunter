...
export function setupDatabas(client: Client) {
  ...
  CREATE TABLE "public"."shows" (
      ...
      "update_disable" bool NOT NULL DEFAULT false,
      PRIMARY KEY ("id")
  );
  ...
  INSERT INTO "public"."shows" ("id", "name", "external_id_imdb", "external_id_tvdb", "airs_first", "airs_time", "airs_day", "genre", "language", "network", "overview", "runtime", "ended", "lastupdated", "lastupdated_check", "update_disable") VALUES ('1', 'Stranger Things', 'tt4574334', '305288', '2016-07-15', '03:00', '4', '{Adventure,Drama,Fantasy,Mystery}', 'en', 'Netflix', 'When a young boy disappears, his mother, a police chief, and his friends must confront terrifying forces in order to get him back.', '50', 'f', '1555393924', '1999999999', 'f');
